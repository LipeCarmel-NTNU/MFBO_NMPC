...
\paragraph{Case 1} All variables are free.
\paragraph{Case 2} The first state-weight exponent is fixed at $q_1=0$, hence $Q_{11}=1$. $r_u=-1000$ so $R_u$ underflows to zero.
